...
**Non-static/static:** Non-static fields belong to individual instances (objects) of the class while static fields are associated with the class itself rather than with specific instances (objects) of the class. Static fields/methods can be accessed without initializing any object while non-static fields/methods have to be accessed via object instances.
